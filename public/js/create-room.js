...
var loading = __webpack_require__(342);

// EXTERNAL MODULE: ./src/scripts/global/output-message.js
var output_message = __webpack_require__(343);
...
var CreateRoom = function () {
  ...
  socket.on('createRoomCompleted', function (_ref) {
    var token = _ref.token,
        roomId = _ref.roomId;
    sessionStorage.setItem('token', token);
    location.href = "/host/chat?room=".concat(roomId);
