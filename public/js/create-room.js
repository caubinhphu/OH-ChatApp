...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__global_loading__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__global_notify__ = __webpack_require__(340);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__global_output_message__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_create_room__ = __webpack_require__(512);
...
var CreateRoom = function () {
  ...
  document.createRoomForm.addEventListener('submit', function (e) {
    e.preventDefault(); // input id room

    var roomIdInput = e.target.elements.roomId; // input password room

    var passRoomInput = e.target.elements.passRoom; // input host name

    var hostnameInput = e.target.elements.hostname; // input member id

    var memberIdInput = e.target.elements.memberId; // send to server
  ...
  socket.on('createRoomCompleted', function (token) {
    location.href = "/host/chat?token=".concat(token);
...
/* unused harmony default export */ var _unused_webpack_default_export = (CreateRoom);
