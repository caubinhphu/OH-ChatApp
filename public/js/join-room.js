...
(function (e) {
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(48)], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
...
/*!
  ...
  */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(48), __webpack_require__(344)) :
...
/*!
  ...
  */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(48)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_js_dist_modal__ = __webpack_require__(343);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__global_loading__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__global_notify__ = __webpack_require__(340);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__global_output_message__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__user_join_room__ = __webpack_require__(515);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__user_join_room___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__user_join_room__);
...
/* WEBPACK VAR INJECTION */(function($) {var joinRoomForm = document.joinRoomForm; // socket.io

var socket = io();
joinRoomForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var nameInput = e.target.elements.name;
  var roomIdInput = e.target.elements.roomId;
  var passRoomInput = e.target.elements.passRoom;
  var memberIdInput = e.target.elements.memberId;
...
socket.on('joinRoomSuccess', function (token) {
  location.href = "/chat?token=".concat(token);
}); // receive info when join room is blocked

socket.on('joinRoomBlocked', function (msg) {
  outputJoinRoomBlocked(msg);
  var leaveBtn = document.getElementById('leave-btn');
  var time = 4;
  leaveBtn.innerHTML = "OK(5)";
  setInterval(function () {
    leaveBtn.innerHTML = "OK(".concat(time, ")");
    time--;
  }, 1000);
  setTimeout(function () {
    location.href = '/';
...
socket.on('toWaitingRoom', function (_ref) {
  var msg = _ref.msg,
      roomId = _ref.roomId,
      userId = _ref.userId;
...
socket.on('leaveWaitingRoomComplete', function (message) {
  if (message === 'OK') {
    location.reload();
  }
