...
/*!
  ...
  */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(30), __webpack_require__(345)) :
  undefined;
...
/* harmony import */ var _global_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(341);
/* harmony import */ var _global_loading__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(342);
/* harmony import */ var _global_output_message__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(343);
    ...
    socket.emit('joinRoom', {
      ...
      if (res.status === 'ok') {
        if (res.isHost) {
          ...
          location.href = "/host/chat?room=".concat(res.roomId);
        } else {
          sessionStorage.setItem('token', res.token);
          location.href = "/chat?room=".concat(res.roomId);
        }
      }
    });
    showLoader();
