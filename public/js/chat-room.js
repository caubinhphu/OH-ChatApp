...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__user_chat_room__ = __webpack_require__(149);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {var ChatRoom = function () {
  var msgForm = document.sendMsgForm; // form chat
  ...
  socket.on('changeStatusRoom', function (_ref) {
    var key = _ref.key,
        value = _ref.value;
  ...
  socket.on('leaveAllComplete', function (msg) {
    if (msg === 'OK') {
      outputLeaveRoom('Host đã kết thúc chat cho tất cả mọi người, quay lại trang chủ');
      fiveSecond();
    } else {
      location.reload();
    }
  ...
  socket.on('kickedOutRoom', function (msg) {
    if (msg === 'OK') {
  ...
  function fiveSecond() {
    ...
    setInterval(function () {
      leaveBtn.innerHTML = "OK (".concat(time, "s)");
      time--;
    }, 1000);
    setTimeout(function () {
      location.href = '/';
...
/* unused harmony default export */ var _unused_webpack_default_export = (ChatRoom);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1)))
