...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {function showLoader() {
...
(function (e) {
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : (typeof module === "undefined" ? "undefined" : _typeof(module)) == "object" && module.exports ? module.exports = function (t, n) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {// output error message
...
/* unused harmony default export */ var _unused_webpack_default_export = (OutputMessage);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1)))
...
/*!
  ...
  */
(function (global, factory) {
   true ? module.exports = factory(__webpack_require__(1), __webpack_require__(133)) :
...
var CommonChatRoom = function () {
  var chatMain = document.getElementById('chat-middle'); // chat main area
  ...
  msgForm.addEventListener('submit', function (e) {
    ...
    if (inputMsg.value !== '') {
      ...
      var msgObj = {
        time: __WEBPACK_IMPORTED_MODULE_0_moment___default()().format('h:mm A'),
        username: 'Me',
  ...
  btnChangeStatusTime.addEventListener('click', function () {
    if (this.dataset.status === 'on') {
      ...
      document.querySelectorAll('.message-time').forEach(function (time) {
  ...
  $('.arrow-smaller').on('click', function () {
    hideControls();
  });
  var conShowPopClass = '.control-show-pop';
  var showConId = '#show-control';
  var wrapConClass = '.wrap-control-meet';
  $(conShowPopClass).on('click', function () {
    var $wrapControls = $(showConId);
    ...
    if ($(this).hasClass('is-active')) {
      ...
      $(".control-area[data-control=\"".concat(this.dataset.control, "\"]")).addClass('is-active'); // remove un-read

      var $chatArea = $('.control-show-pop[data-control="chat"]');
      var $userArea = $('.control-show-pop[data-control="user"]');
  ...
  $('.open-popup-icon').on('click', function () {
    hideControls();
    $('.open-popup-icon').removeClass('has-unread');
  ...
  $(document).click(function (e) {
    ...
    if (!$target.closest('.open-popup-icon').length && !$target.closest('.wrap-control-meet .control-show-pop').length && $(wrapConClass).is(':visible')) {
      $(wrapConClass).fadeOut();
    }
  });
...
/* unused harmony default export */ var _unused_webpack_default_export = (CommonChatRoom);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_js_dist_modal__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bootstrap_js_dist_modal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_bootstrap_js_dist_modal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__global_loading__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__global_notify__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__global_notify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__global_notify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__global_output_message__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__global_common_chat__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__global_emoji__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__user_common_chat_room__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__user_chat_room_host__ = __webpack_require__(147);
...
console.log('page chat room host');
...
var ChatRoomHost = function () {
  var waitingRoomArea = document.getElementById('waiting-room');
  var waitingRoomUsers = document.getElementById('waiting-room-users');
  var allowJoinBtn = document.getElementById('allow-join-btn');
  var noAllowJoinBtn = document.getElementById('no-allow-join-btn');
  var kickUserBtn = document.getElementById('confirm-kick-user-btn');
  var roomName = document.getElementById('room-info-name-room'); // room name

  var participants = document.getElementById('room-users'); // participants area
  ...
  socket.on('changeWaitingRoom', function (_ref) {
    var waitingRoom = _ref.waitingRoom;
  ...
  function outputWaitingRoom(waitingRoom) {
    if (waitingRoom.length > 0) {
      ...
      _toConsumableArray(document.getElementsByClassName('waiting-room-allow-btn')).forEach(function (btn) {
        btn.addEventListener('click', function () {
          allowJoinBtn.dataset.id = this.dataset.id;
        });
      });

      _toConsumableArray(document.getElementsByClassName('waiting-room-not-allow-btn')).forEach(function (btn) {
        btn.addEventListener('click', function () {
...
/* unused harmony default export */ var _unused_webpack_default_export = (ChatRoomHost);
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1)))
