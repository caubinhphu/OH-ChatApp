...
/* harmony import */ var _global_output_message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(536);
/* harmony import */ var _member_chat_audio__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(538);
// import $ from 'jquery';
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _notify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(537);
...
var ChatAudio = function () {
  ...
  if (window.typeCall === 'receiver') {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              peer.send('OK');
              console.log(window.localStream); // peer.addTrack(
    ...
    peer.on('data', /*#__PURE__*/function () {
    ...
    $(window).on('changePeer', function () {
      var peer = window.peer;
      peer.signal(JSON.parse(window.signalPeer));
      peer.on('connect', function () {
        return console.log('answer1 connect');
      });
